...
You might also like [awesome-php](https://github.com/ziadoz/awesome-php) ⭐ 32,688 | 🐛 90 | 📅 2026-07-13.
...
* [GitHub](https://github.com/composer/composer) ⭐ 29,520 | 🐛 160 | 🌐 PHP | 📅 2026-09-10
* [Issues](https://github.com/composer/composer/issues) ⭐ 29,520 | 🐛 160 | 🌐 PHP | 📅 2026-09-10
* [Source](https://github.com/composer/composer/tree/HEAD/src/Composer) ⭐ 29,520 | 🐛 160 | 🌐 PHP | 📅 2026-09-10
...
* [Prestissimo](https://github.com/hirak/prestissimo) ⭐ 6,115 | 🐛 40 | 🌐 PHP | 📅 2022-12-03 - A parallel downloader using `phpext_curl`.
* [Symfony-Flex](https://github.com/symfony/flex) ⭐ 4,209 | 🐛 23 | 🌐 PHP | 📅 2026-05-29 - Provides [recipe-based](https://github.com/symfony/recipes) ⭐ 1,027 | 🐛 46 | 🌐 PHP | 📅 2026-09-09 installation and configuration management for Symfony packages.
* [PackageVersions](https://github.com/Ocramius/PackageVersions) ⭐ 3,170 | 🐛 2 | 🌐 PHP | 📅 2026-09-11 - Provides a very quick and easy access to installed composer dependency versions.
* [Composer-Patches](https://github.com/cweagans/composer-patches) ⭐ 1,727 | 🐛 57 | 🌐 PHP | 📅 2026-08-31 - The plugin applies a patch from a local or remote file to any required package.
...
* [PHPCodeSniffer-Composer-Installer](https://github.com/PHPCSStandards/composer-installer) ⭐ 601 | 🐛 6 | 🌐 PHP | 📅 2026-09-09 - The plugin enables you to install [PHP\_CodeSniffer](https://github.com/PHPCSStandards/PHP_CodeSniffer) ⭐ 1,556 | 🐛 204 | 🌐 PHP | 📅 2026-09-11 coding standards (rulesets).
...
* [Composer Translation Validator](https://github.com/move-elevator/composer-translation-validator) ⭐ 3 | 🐛 2 | 🌐 PHP | 📅 2026-09-11 - Validates translation files in your project, supports several file formats (regarding different frameworks) and provides useful validators for comparison, consistency and syntax checks.
...
* [Composer-Unused](https://github.com/composer-unused/composer-unused) ⭐ 1,690 | 🐛 15 | 🌐 PHP | 📅 2026-09-04 - A CLI tool, which scans your code and shows unused Composer dependencies.
...
* [ComposerRequireChecker](https://github.com/maglnet/ComposerRequireChecker) ⭐ 1,011 | 🐛 45 | 🌐 PHP | 📅 2026-09-11 - A CLI tool to analyze dependencies and verify that no unknown imported symbols are used in the sources of a package.
