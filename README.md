...
You might also like [awesome-php](https://github.com/ziadoz/awesome-php) ⭐ 32,678 | 🐛 85 | 📅 2026-07-13.
...
* [GitHub](https://github.com/composer/composer) ⭐ 29,511 | 🐛 154 | 🌐 PHP | 📅 2026-09-03
* [Issues](https://github.com/composer/composer/issues) ⭐ 29,511 | 🐛 154 | 🌐 PHP | 📅 2026-09-03
* [Source](https://github.com/composer/composer/tree/HEAD/src/Composer) ⭐ 29,511 | 🐛 154 | 🌐 PHP | 📅 2026-09-03
...
* [Prestissimo](https://github.com/hirak/prestissimo) ⭐ 6,117 | 🐛 40 | 🌐 PHP | 📅 2022-12-03 - A parallel downloader using `phpext_curl`.
* [Symfony-Flex](https://github.com/symfony/flex) ⭐ 4,209 | 🐛 23 | 🌐 PHP | 📅 2026-05-29 - Provides [recipe-based](https://github.com/symfony/recipes) ⭐ 1,027 | 🐛 41 | 🌐 PHP | 📅 2026-09-04 installation and configuration management for Symfony packages.
* [PackageVersions](https://github.com/Ocramius/PackageVersions) ⭐ 3,170 | 🐛 2 | 🌐 PHP | 📅 2026-09-05 - Provides a very quick and easy access to installed composer dependency versions.
...
* [Composer-Diff](https://github.com/IonBazan/composer-diff) ⭐ 188 | 🐛 3 | 🌐 PHP | 📅 2026-07-17 - Compares `composer.lock` changes and generates a Markdown report for usage in a pull request description.
...
* [Composer-Normalize](https://github.com/ergebnis/composer-normalize) ⭐ 1,122 | 🐛 27 | 🌐 PHP | 📅 2026-08-30 - The plugin helps to keep your `composer.json` file(s) consistent by restructuring and sorting entries (normalizing).
