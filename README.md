...
You might also like [awesome-php](https://github.com/ziadoz/awesome-php) ⭐ 32,679 | 🐛 86 | 📅 2026-07-13.
...
* [GitHub](https://github.com/composer/composer) ⭐ 29,513 | 🐛 158 | 🌐 PHP | 📅 2026-09-03
* [Issues](https://github.com/composer/composer/issues) ⭐ 29,513 | 🐛 158 | 🌐 PHP | 📅 2026-09-03
* [Source](https://github.com/composer/composer/tree/HEAD/src/Composer) ⭐ 29,513 | 🐛 158 | 🌐 PHP | 📅 2026-09-03
...
* [Symfony-Flex](https://github.com/symfony/flex) ⭐ 4,209 | 🐛 23 | 🌐 PHP | 📅 2026-05-29 - Provides [recipe-based](https://github.com/symfony/recipes) ⭐ 1,027 | 🐛 43 | 🌐 PHP | 📅 2026-09-06 installation and configuration management for Symfony packages.
* [PackageVersions](https://github.com/Ocramius/PackageVersions) ⭐ 3,170 | 🐛 2 | 🌐 PHP | 📅 2026-09-07 - Provides a very quick and easy access to installed composer dependency versions.
* [Composer-Patches](https://github.com/cweagans/composer-patches) ⭐ 1,725 | 🐛 57 | 🌐 PHP | 📅 2026-08-31 - The plugin applies a patch from a local or remote file to any required package.
...
* [Composer-Dependency-Analyzer](https://github.com/shipmonk-rnd/composer-dependency-analyser) ⭐ 630 | 🐛 19 | 🌐 PHP | 📅 2026-08-11 - The plugin helps to find dependency issues, including dead, unused, shadow and misplaced dependencies.
* [PHPCodeSniffer-Composer-Installer](https://github.com/PHPCSStandards/composer-installer) ⭐ 601 | 🐛 6 | 🌐 PHP | 📅 2026-08-07 - The plugin enables you to install [PHP\_CodeSniffer](https://github.com/PHPCSStandards/PHP_CodeSniffer) ⭐ 1,553 | 🐛 201 | 🌐 PHP | 📅 2026-09-05 coding standards (rulesets).
...
* [Composer-Patches](https://github.com/vaimo/composer-patches) ⭐ 304 | 🐛 36 | 🌐 PHP | 📅 2026-09-04 - Applies a patch from a local or remote file to any package that is part of a given composer project.
...
* [Composer-Plugin-Exclude-Files](https://github.com/mcaskill/composer-plugin-exclude-files) ⭐ 41 | 🐛 0 | 🌐 PHP | 📅 2026-08-01 - A plugin for excluding files required by packages using the 'files' autoloading mechanism.
...
* [Composer Translation Validator](https://github.com/move-elevator/composer-translation-validator) ⭐ 3 | 🐛 2 | 🌐 PHP | 📅 2026-09-05 - Validates translation files in your project, supports several file formats (regarding different frameworks) and provides useful validators for comparison, consistency and syntax checks.
...
* [Composer/Xdebug-Handler](https://github.com/composer/xdebug-handler) ⭐ 2,566 | 🐛 1 | 🌐 PHP | 📅 2026-09-01 - Helps you to restart a CLI process without loading the xdebug extension.
...
* [Composer-Normalize](https://github.com/ergebnis/composer-normalize) ⭐ 1,122 | 🐛 27 | 🌐 PHP | 📅 2026-09-06 - The plugin helps to keep your `composer.json` file(s) consistent by restructuring and sorting entries (normalizing).
* [ComposerRequireChecker](https://github.com/maglnet/ComposerRequireChecker) ⭐ 1,009 | 🐛 45 | 🌐 PHP | 📅 2026-09-05 - A CLI tool to analyze dependencies and verify that no unknown imported symbols are used in the sources of a package.
...
* [Private Packagist API Client](https://github.com/packagist/private-packagist-api-client) ⭐ 37 | 🐛 2 | 🌐 PHP | 📅 2026-09-04 - A PHP client for the Private Packagist API. The client handles authentication, signature generation and access to all endpoints.
...
* [repman.io](https://repman.io) & [repman-io/repman](https://github.com/repman-io/repman) ⭐ 584 | 🐛 127 | 🌐 PHP | 📅 2026-08-24 - A Private PHP Package Repository Manager & Packagist Proxy.
...
* [Packeton](https://github.com/vtsykun/packeton) ⭐ 542 | 🐛 54 | 🌐 PHP | 📅 2026-04-29 - Private self-hosted Composer repository for vendors. Fork of packagist with adding support for authorization, customer users, groups, webhooks.
