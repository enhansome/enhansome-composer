...
You might also like [awesome-php](https://github.com/ziadoz/awesome-php) ⭐ 32,665 | 🐛 85 | 📅 2026-07-13.
...
* [GitHub](https://github.com/composer/composer) ⭐ 29,504 | 🐛 166 | 🌐 PHP | 📅 2026-08-13
* [Issues](https://github.com/composer/composer/issues) ⭐ 29,504 | 🐛 166 | 🌐 PHP | 📅 2026-08-13
* [Source](https://github.com/composer/composer/tree/HEAD/src/Composer) ⭐ 29,504 | 🐛 166 | 🌐 PHP | 📅 2026-08-13
...
* [Symfony-Flex](https://github.com/symfony/flex) ⭐ 4,213 | 🐛 21 | 🌐 PHP | 📅 2026-05-29 - Provides [recipe-based](https://github.com/symfony/recipes) ⭐ 1,026 | 🐛 45 | 🌐 PHP | 📅 2026-08-20 installation and configuration management for Symfony packages.
...
* [Composer-Patches](https://github.com/cweagans/composer-patches) ⭐ 1,721 | 🐛 56 | 🌐 PHP | 📅 2026-08-10 - The plugin applies a patch from a local or remote file to any required package.
...
* [PHPCodeSniffer-Composer-Installer](https://github.com/PHPCSStandards/composer-installer) ⭐ 601 | 🐛 6 | 🌐 PHP | 📅 2026-08-07 - The plugin enables you to install [PHP\_CodeSniffer](https://github.com/PHPCSStandards/PHP_CodeSniffer) ⭐ 1,546 | 🐛 197 | 🌐 PHP | 📅 2026-08-20 coding standards (rulesets).
...
* [Private Packagist API Client](https://github.com/packagist/private-packagist-api-client) ⭐ 37 | 🐛 2 | 🌐 PHP | 📅 2026-08-20 - A PHP client for the Private Packagist API. The client handles authentication, signature generation and access to all endpoints.

### Repman

* [repman.io](https://repman.io) & [repman-io/repman](https://github.com/repman-io/repman) ⭐ 583 | 🐛 127 | 🌐 PHP | 📅 2026-02-06 - A Private PHP Package Repository Manager & Packagist Proxy.
...
* [Packeton](https://github.com/vtsykun/packeton) ⭐ 539 | 🐛 54 | 🌐 PHP | 📅 2026-04-29 - Private self-hosted Composer repository for vendors. Fork of packagist with adding support for authorization, customer users, groups, webhooks.
