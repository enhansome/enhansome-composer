...
You might also like [awesome-php](https://github.com/ziadoz/awesome-php) ⭐ 32,685 | 🐛 89 | 📅 2026-07-13.

*Please read the [contribution guidelines](https://github.com/jakoch/awesome-composer/blob/main/.github/CONTRIBUTING.md) ⭐ 906 | 🐛 0 | 📅 2026-07-26 before contributing.*

## Composer

* [GitHub](https://github.com/composer/composer) ⭐ 29,514 | 🐛 155 | 🌐 PHP | 📅 2026-09-03
* [Issues](https://github.com/composer/composer/issues) ⭐ 29,514 | 🐛 155 | 🌐 PHP | 📅 2026-09-03
* [Source](https://github.com/composer/composer/tree/HEAD/src/Composer) ⭐ 29,514 | 🐛 155 | 🌐 PHP | 📅 2026-09-03
...
* [Prestissimo](https://github.com/hirak/prestissimo) ⭐ 6,116 | 🐛 40 | 🌐 PHP | 📅 2022-12-03 - A parallel downloader using `phpext_curl`.
* [Symfony-Flex](https://github.com/symfony/flex) ⭐ 4,209 | 🐛 23 | 🌐 PHP | 📅 2026-05-29 - Provides [recipe-based](https://github.com/symfony/recipes) ⭐ 1,027 | 🐛 45 | 🌐 PHP | 📅 2026-09-09 installation and configuration management for Symfony packages.
* [PackageVersions](https://github.com/Ocramius/PackageVersions) ⭐ 3,170 | 🐛 3 | 🌐 PHP | 📅 2026-09-10 - Provides a very quick and easy access to installed composer dependency versions.
* [Composer-Patches](https://github.com/cweagans/composer-patches) ⭐ 1,726 | 🐛 57 | 🌐 PHP | 📅 2026-08-31 - The plugin applies a patch from a local or remote file to any required package.
...
* [Composer-Asset-Plugin](https://github.com/fxpio/composer-asset-plugin) ⭐ 886 | 🐛 15 | 🌐 PHP | 📅 2023-02-28 - A npm/Bower Dependencies Manager for Composer.
* [Composer-Dependency-Analyzer](https://github.com/shipmonk-rnd/composer-dependency-analyser) ⭐ 631 | 🐛 19 | 🌐 PHP | 📅 2026-08-11 - The plugin helps to find dependency issues, including dead, unused, shadow and misplaced dependencies.
* [PHPCodeSniffer-Composer-Installer](https://github.com/PHPCSStandards/composer-installer) ⭐ 601 | 🐛 6 | 🌐 PHP | 📅 2026-09-09 - The plugin enables you to install [PHP\_CodeSniffer](https://github.com/PHPCSStandards/PHP_CodeSniffer) ⭐ 1,556 | 🐛 204 | 🌐 PHP | 📅 2026-09-05 coding standards (rulesets).
...
* [Composer-Patches](https://github.com/vaimo/composer-patches) ⭐ 304 | 🐛 38 | 🌐 PHP | 📅 2026-09-08 - Applies a patch from a local or remote file to any package that is part of a given composer project.
...
* [Composer Preload](https://github.com/Ayesh/Composer-Preload) ⭐ 208 | 🐛 4 | 🌐 PHP | 📅 2022-05-16 - The plugin generates a `vendor/preload.php` file to warm up the Opcache.
* [Composer-Diff](https://github.com/IonBazan/composer-diff) ⭐ 188 | 🐛 3 | 🌐 PHP | 📅 2026-09-06 - Compares `composer.lock` changes and generates a Markdown report for usage in a pull request description.
...
* [Foxy](https://github.com/fxpio/foxy) ⭐ 175 | 🐛 5 | 🌐 PHP | 📅 2024-07-29 - Composer plugin that executes npm/yarn packages installation operations, when composer package is installed or updated.
...
* [Imposter-Plugin](https://github.com/typisttech/imposter-plugin) ⭐ 156 | 🐛 8 | 🌐 PHP | 📅 2026-08-10 - Wrapping all composer vendor packages inside your own namespace. Intended for WordPress plugins.
...
* [Composer-Custom-Directory-Installer](https://github.com/mnsami/composer-custom-directory-installer) ⭐ 145 | 🐛 0 | 🌐 PHP | 📅 2026-05-20 - A composer plugin, to install different types of composer packages in custom directories outside the default composer installation path (vendor folder).
* [Composer-Cleaner](https://github.com/dg/composer-cleaner) ⭐ 136 | 🐛 7 | 🌐 PHP | 📅 2026-07-13 - The tool removes unnecessary files and directories from the vendor directory.
...
* [Composer-Patches-Plugin](https://github.com/netresearch/composer-patches-plugin) ⭐ 80 | 🐛 1 | 🌐 PHP | 📅 2026-07-19 - Enables you to provide patches for any package from any package. When the dependency is fetched, the patch is applied on top.
...
* [Composer-Plugin-Exclude-Files](https://github.com/mcaskill/composer-plugin-exclude-files) ⭐ 41 | 🐛 0 | 🌐 PHP | 📅 2026-09-09 - A plugin for excluding files required by packages using the 'files' autoloading mechanism.
...
* [Drupal Vendor Hardening Composer Plugin](https://github.com/drupal/core-vendor-hardening) ⭐ 17 | 🐛 1 | 🌐 PHP | 📅 2026-09-03 - Removes extraneous directories from the project's vendor directory & adds .htaccess and web.config files to the root of the project's vendor directory.
...
* [Composer Translation Validator](https://github.com/move-elevator/composer-translation-validator) ⭐ 3 | 🐛 2 | 🌐 PHP | 📅 2026-09-10 - Validates translation files in your project, supports several file formats (regarding different frameworks) and provides useful validators for comparison, consistency and syntax checks.
...
* [OctoLinker Browser Extension](https://github.com/OctoLinker/OctoLinker) ⭐ 5,384 | 🐛 62 | 🌐 HTML | 📅 2023-10-02 - Enables you to navigate Composer/NPM dependencies on GitHub.
...
* [Composer-Unused](https://github.com/composer-unused/composer-unused) ⭐ 1,688 | 🐛 15 | 🌐 PHP | 📅 2026-09-04 - A CLI tool, which scans your code and shows unused Composer dependencies.
...
* [Composer-Normalize](https://github.com/ergebnis/composer-normalize) ⭐ 1,123 | 🐛 8 | 🌐 PHP | 📅 2026-09-09 - The plugin helps to keep your `composer.json` file(s) consistent by restructuring and sorting entries (normalizing).
* [ComposerRequireChecker](https://github.com/maglnet/ComposerRequireChecker) ⭐ 1,009 | 🐛 46 | 🌐 PHP | 📅 2026-09-10 - A CLI tool to analyze dependencies and verify that no unknown imported symbols are used in the sources of a package.
...
* [ParameterHandler](https://github.com/Incenteev/ParameterHandler) ⭐ 930 | 🐛 32 | 🌐 PHP | 📅 2025-11-26 - Allows you to manage your ignored parameters when running a composer install or update.
* [Melody](https://github.com/sensiolabs/melody) ⚠️ Archived - One-file composer scripts.
* [PhantomJS-Installer](https://github.com/jakoch/phantomjs-installer) ⭐ 150 | 🐛 1 | 🌐 PHP | 📅 2026-07-02 - A Composer Package which installs the PhantomJS binary (Linux, Windows, Mac) into /bin of your project.
...
* [Private Packagist API Client](https://github.com/packagist/private-packagist-api-client) ⭐ 37 | 🐛 1 | 🌐 PHP | 📅 2026-09-07 - A PHP client for the Private Packagist API. The client handles authentication, signature generation and access to all endpoints.
...
* [repman.io](https://repman.io) & [repman-io/repman](https://github.com/repman-io/repman) ⭐ 584 | 🐛 127 | 🌐 PHP | 📅 2026-09-08 - A Private PHP Package Repository Manager & Packagist Proxy.
...
* [Packeton](https://github.com/vtsykun/packeton) ⭐ 546 | 🐛 54 | 🌐 PHP | 📅 2026-04-29 - Private self-hosted Composer repository for vendors. Fork of packagist with adding support for authorization, customer users, groups, webhooks.
