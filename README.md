...
You might also like [awesome-php](https://github.com/ziadoz/awesome-php) ⭐ 32,673 | 🐛 85 | 📅 2026-07-13.
...
* [GitHub](https://github.com/composer/composer) ⭐ 29,507 | 🐛 154 | 🌐 PHP | 📅 2026-08-28
* [Issues](https://github.com/composer/composer/issues) ⭐ 29,507 | 🐛 154 | 🌐 PHP | 📅 2026-08-28
* [Source](https://github.com/composer/composer/tree/HEAD/src/Composer) ⭐ 29,507 | 🐛 154 | 🌐 PHP | 📅 2026-08-28
...
* [Symfony-Flex](https://github.com/symfony/flex) ⭐ 4,211 | 🐛 21 | 🌐 PHP | 📅 2026-05-29 - Provides [recipe-based](https://github.com/symfony/recipes) ⭐ 1,025 | 🐛 50 | 🌐 PHP | 📅 2026-08-29 installation and configuration management for Symfony packages.
* [PackageVersions](https://github.com/Ocramius/PackageVersions) ⭐ 3,171 | 🐛 2 | 🌐 PHP | 📅 2026-09-01 - Provides a very quick and easy access to installed composer dependency versions.
* [Composer-Patches](https://github.com/cweagans/composer-patches) ⭐ 1,724 | 🐛 56 | 🌐 PHP | 📅 2026-08-31 - The plugin applies a patch from a local or remote file to any required package.
...
* [Composer-Dependency-Analyzer](https://github.com/shipmonk-rnd/composer-dependency-analyser) ⭐ 628 | 🐛 19 | 🌐 PHP | 📅 2026-08-11 - The plugin helps to find dependency issues, including dead, unused, shadow and misplaced dependencies.
...
* [Drupal Vendor Hardening Composer Plugin](https://github.com/drupal/core-vendor-hardening) ⭐ 17 | 🐛 1 | 🌐 PHP | 📅 2026-08-18 - Removes extraneous directories from the project's vendor directory & adds .htaccess and web.config files to the root of the project's vendor directory.
...
* [Composer Translation Validator](https://github.com/move-elevator/composer-translation-validator) ⭐ 3 | 🐛 2 | 🌐 PHP | 📅 2026-09-01 - Validates translation files in your project, supports several file formats (regarding different frameworks) and provides useful validators for comparison, consistency and syntax checks.
...
* [ComposerRequireChecker](https://github.com/maglnet/ComposerRequireChecker) ⭐ 1,010 | 🐛 45 | 🌐 PHP | 📅 2026-09-01 - A CLI tool to analyze dependencies and verify that no unknown imported symbols are used in the sources of a package.
