...
You might also like [awesome-php](https://github.com/ziadoz/awesome-php) ⭐ 32,683 | 🐛 89 | 📅 2026-07-13.
...
* [PackageVersions](https://github.com/Ocramius/PackageVersions) ⭐ 3,170 | 🐛 2 | 🌐 PHP | 📅 2026-09-09 - Provides a very quick and easy access to installed composer dependency versions.
...
* [PHPCodeSniffer-Composer-Installer](https://github.com/PHPCSStandards/composer-installer) ⭐ 601 | 🐛 7 | 🌐 PHP | 📅 2026-09-07 - The plugin enables you to install [PHP\_CodeSniffer](https://github.com/PHPCSStandards/PHP_CodeSniffer) ⭐ 1,552 | 🐛 204 | 🌐 PHP | 📅 2026-09-05 coding standards (rulesets).
...
* [Composer-Plugin-Exclude-Files](https://github.com/mcaskill/composer-plugin-exclude-files) ⭐ 41 | 🐛 1 | 🌐 PHP | 📅 2026-09-08 - A plugin for excluding files required by packages using the 'files' autoloading mechanism.
...
* [Composer Translation Validator](https://github.com/move-elevator/composer-translation-validator) ⭐ 3 | 🐛 2 | 🌐 PHP | 📅 2026-09-09 - Validates translation files in your project, supports several file formats (regarding different frameworks) and provides useful validators for comparison, consistency and syntax checks.
...
* [Packeton](https://github.com/vtsykun/packeton) ⭐ 545 | 🐛 54 | 🌐 PHP | 📅 2026-04-29 - Private self-hosted Composer repository for vendors. Fork of packagist with adding support for authorization, customer users, groups, webhooks.
