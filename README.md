...
You might also like [awesome-php](https://github.com/ziadoz/awesome-php) ⭐ 32,678 | 🐛 87 | 📅 2026-07-13.
...
* [PackageVersions](https://github.com/Ocramius/PackageVersions) ⭐ 3,170 | 🐛 2 | 🌐 PHP | 📅 2026-09-08 - Provides a very quick and easy access to installed composer dependency versions.
...
* [PHPCodeSniffer-Composer-Installer](https://github.com/PHPCSStandards/composer-installer) ⭐ 601 | 🐛 7 | 🌐 PHP | 📅 2026-09-07 - The plugin enables you to install [PHP\_CodeSniffer](https://github.com/PHPCSStandards/PHP_CodeSniffer) ⭐ 1,553 | 🐛 204 | 🌐 PHP | 📅 2026-09-05 coding standards (rulesets).
...
* [Composer-Patches](https://github.com/vaimo/composer-patches) ⭐ 304 | 🐛 37 | 🌐 PHP | 📅 2026-09-07 - Applies a patch from a local or remote file to any package that is part of a given composer project.
...
* [Composer-Normalize](https://github.com/ergebnis/composer-normalize) ⭐ 1,123 | 🐛 27 | 🌐 PHP | 📅 2026-09-06 - The plugin helps to keep your `composer.json` file(s) consistent by restructuring and sorting entries (normalizing).
...
* [Packeton](https://github.com/vtsykun/packeton) ⭐ 543 | 🐛 54 | 🌐 PHP | 📅 2026-04-29 - Private self-hosted Composer repository for vendors. Fork of packagist with adding support for authorization, customer users, groups, webhooks.
